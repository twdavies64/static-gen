...
class TestBlockToBlockType(unittest.TestCase):
    ...
    def test_invalid_blocks(self):
        ...
        # Test that ordered lists must be sequential
        block = "1. First item\n3. Third item"
        self.assertEqual(block_to_block_type(block), BlockType.PARAGRAPH)
...
class TestMarkdownToHTMLNode(unittest.TestCase):
    ...
    # 1: Test empty markdown document
    ...
    # 2: Test multiple levels of headings
    ...
    # 3: Test mixed block types in single document
    ...
    # 5: Test consecutive blocks of the same type
    ...
    # 7: Test code block with language specification
    ...
    # 8: Test document with only inline formatting (no blocks)
    ...
    """
        ...
        self.assertEqual(
            html,
            "<div><h1></h1><blockquote></blockquote><pre><code></code></pre><ul><li></li></ul></div>",
        )

    # 10: Test multiple paragraph breaks
    ...
    # 11
    # This test checks if a list properly nests within a blockquote.
    # The `<blockquote>` should encapsulate the `<ul>` block,
    # and each list item (`<li>`) should retain its expected formatting,
    # including correctly parsed inline markdown (e.g., `<b>` for bold).
    ...
    """
        ...
        self.assertEqual(
            html,
            "<div><blockquote><ul><li>Item 1</li><li>Item 2 with <b>bold</b> text</li></ul></blockquote></div>",
        )

    # 12
    # This test ensures that nested blockquotes are handled correctly.
    # At each level of nesting, a new `<blockquote>` should wrap the content of that level.
    # Inline formatting like `_italic_` to `<i>` and `**bold**` to `<b>` should still be preserved inside.
    def test_nested_blockquotes(self):
        md = """
    > This is a blockquote
    > > Nested blockquote here with _italic_ text
    > > > Even more nested with **bold** text
    """
        node = markdown_to_html_node(md)
        html = node.to_html()
        self.assertEqual(
            html,
            "<div><blockquote>This is a blockquote<blockquote>Nested blockquote here with <i>italic</i> text<blockquote>Even more nested with <b>bold</b> text</blockquote></blockquote></blockquote></div>",
        )
